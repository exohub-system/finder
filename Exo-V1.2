...
titleLbl.Text = "PLAYER FINDER  V1.2"
...
local function findPlayer()
    ...
    if not ok1 or not userData or not userData.data or #userData.data == 0 then
    ...
    local userId = userData.data[1].id
    local displayName = userData.data[1].name
